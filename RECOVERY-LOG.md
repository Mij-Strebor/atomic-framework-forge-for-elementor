...
**Commit:** c6ae2bf
**Git Tag:** v1.2.0
**Zip Backup:** 260613 aff-v1.2.0-release-complete.zip
...
**What Changed:**
- grid-template-columns updated in aff-colors.css, aff-variables.css, and class-aff-admin.php get_grid_override_css()
...
- AFF.Icons.homeSVG() added; back buttons in aff-colors.js and aff-variables.js updated
