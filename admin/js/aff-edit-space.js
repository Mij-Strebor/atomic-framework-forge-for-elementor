	...
	AFF.EditSpace = {
		...
		_buildInfoPanel: function () {
			...
			return '<div class="aff-info-panel">'
				...
				+ '<li><strong>Portable Format</strong> — <code>.aff.json</code> project files are platform-agnostic and designed for future desktop app compatibility</li>'
				...
				+ '<li>Click <strong>Save Project</strong> to persist your work as a <code>.aff.json</code> backup file</li>'
				...
				+ '<ul class="aff-info-list">'
				+ '<li><span class="aff-info-phase aff-info-phase--current">v1.x \u2014 Current</span> Full Variables workflow: sync from Elementor, organize into categories, inline edit, versioned backups, commit back to the kit, light/dark mode</li>'
				+ '<li><span class="aff-info-phase aff-info-phase--next">v2.0</span> Classes management \u2014 developer-defined CSS class names on atomic widgets; Change History log</li>'
				+ '<li><span class="aff-info-phase aff-info-phase--future">v3.0</span> Components registry; Elementor Kit Manager API write-back</li>'
				+ '<li><span class="aff-info-phase aff-info-phase--future">Future</span> Standalone Windows/Mac desktop application</li>'
				+ '</ul>'
				+ '</section>'
				...
				+ '<a class="aff-info-related__status aff-info-related__status--available" href="https://wordpress.org/plugins/media-inventory-forge/" target="_blank" rel="noopener noreferrer">Available at WordPress.org/plugins</a>'
				+ '</li>'
				+ '<li>'
				+ '<span class="aff-info-related__name">Fluid Button Forge</span>'
				+ '<span class="aff-info-related__desc">Responsive button design system with color management and Elementor integration</span>'
				+ '<span class="aff-info-related__status aff-info-related__status--dev">In Development</span>'
				+ '</li>'
				+ '<li>'
				+ '<span class="aff-info-related__name">Color Inventory Forge</span>'
